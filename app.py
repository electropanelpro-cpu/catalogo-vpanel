...
def contacto():
    ...
    if es_celular():
        return render_template('contacto_celular.html')
...
if __name__ == '__main__':
    with app.app_context():
        if os.path.exists(db_path):
            ...
            except: print("AVISO: Cierra programas de DB para actualizar proyectos.")
        db.create_all()
    ...
    if GUI_AVAILABLE:
        ...
        webview.start(lambda v: v.evaluate_js("localStorage.clear();"), ventana, private_mode=True)
    else:
